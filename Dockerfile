...
#patch xauth 2: echo "ffff$(xxd -p -s 2 ~/.Xauthority)" | xxd -r -p > /tmp/nxauth
#run, patched xauth: docker run -ti -v '/tmp/.X11-unix:/tmp/.X11-unix' -v "$(readlink -f /tmp/nxauth):/xauth" -e 'XAUTHORITY=/xauth' 28feb2018/docker-x
